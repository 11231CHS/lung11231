...
smoke = st.sidebar.slider("🚬 흡연 정도", 0.0, 40.0, 3.0, 0.1)
...
cluster_desc = {
    0: "전반적으로 건강하지만 생활 습관 관리가 필요한 그룹입니다.",
    1: "일부 위험 요인이 존재하지만 평균 수준의 건강 상태를 보이는 그룹입니다.",
    2: "흡연 및 음주 수치가 매우 낮고 건강 상태가 안정적인 그룹입니다.",
    3: "흡연·음주 위험도가 높아 폐 건강 관리가 중요한 고위험 그룹입니다."
}

doctor_tip = {
    0: "현재 상태는 양호하지만 꾸준한 건강 관리가 중요합니다.",
    1: "흡연과 음주 빈도를 조금 줄이면 건강 유지에 도움이 됩니다.",
    2: "현재 생활 습관이 매우 안정적입니다. 규칙적인 운동을 유지하세요.",
...
with col2:
    ...
    st.info("🔵 0번 군집 : 비교적 건강한 그룹")
    st.info("🟡 1번 군집 : 평균적인 위험도")
    st.info("🟢 2번 군집 : 매우 건강한 생활 패턴")
